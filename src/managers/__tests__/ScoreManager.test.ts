...
describe('ScoreManager', () => {
  ...
  describe('display creation', () => {
    it('should create score display elements', () => {
      scoreManager.createDisplay(20, 20);
      
      expect(mockScene.add.text).toHaveBeenCalledTimes(3); // score, streak, high score
      expect(mockScene.add.text).toHaveBeenCalledWith(20, 20, 'Score: 0', expect.any(Object));
      expect(mockScene.add.text).toHaveBeenCalledWith(20, 60, 'Streak: 0', expect.any(Object));
